...
@Component({
  ...
  styles: [
    `
      ...
      .badge { font-size: 11px; font-weight: 700; text-transform: uppercase; padding: 4px 10px; border-radius: 999px; background: rgba(var(--app-primary-rgb),0.2); color: #111827; }
